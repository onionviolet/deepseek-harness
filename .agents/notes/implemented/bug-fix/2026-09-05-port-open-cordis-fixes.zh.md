...
- `#110` 未按原样移植；它所针对的顺序问题由[卸载顺序的重新设计](../architecture/2026-09-05-unload-ordering-and-cancellation.md)关闭，而上面的证据正是通向它的线索。
